...
export const statusLabel: Record<TaskStatus, string> = {
  ...
  beautify_inventory_building: "构建美化清单",
  beautify_planning: "生成美化计划",
  awaiting_beautify_confirm: "审查美化计划",
...
export const statusTone: Record<TaskStatus, "idle" | "active" | "waiting" | "done" | "bad"> = {
  ...
  beautify_inventory_building: "active",
  beautify_planning: "active",
  awaiting_beautify_confirm: "waiting",
...
export const artifactKindLabel: Record<string, string> = {
  ...
  beautify_inputs: "美化输入契约",
  beautify_inventory: "美化内容清单",
  beautify_risk_report: "美化风险报告",
  beautify_plan: "美化计划",
  beautify_lock: "美化锁",
  beautify_fidelity_report: "美化保真报告",
  source_svg_reference: "源 SVG 参考",
  other: "其他",
};
