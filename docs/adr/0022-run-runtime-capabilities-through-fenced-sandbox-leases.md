...
Status: Accepted, amended by [ADR 0029](./0029-bind-runtime-admission-once-before-post-lease-prerequisites.md).

ADR 0029 supersedes two narrow parts of this record. A canonical start binds a
...
Debt operations use a separate internal operational port rather than new
