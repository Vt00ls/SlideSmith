...
func Register(engine *gin.Engine, handlers Handlers) {
	...
	api.GET("/tasks/:id/beautify-plan", handlers.Tasks.GetBeautifyPlan)
	api.PUT("/tasks/:id/beautify-plan", handlers.Tasks.SaveBeautifyPlan)
	api.POST("/tasks/:id/beautify-plan/check", handlers.Tasks.CheckBeautifyPlan)
	api.POST("/tasks/:id/beautify-plan/confirm", handlers.Tasks.ConfirmBeautifyPlan)
	api.POST("/tasks/:id/beautify-plan/regenerate", handlers.Tasks.RegenerateBeautifyPlan)
	...
	api.GET("/tasks/:id/versions", handlers.Tasks.ListArtifactVersions)
	api.GET("/tasks/:id/versions/:version", handlers.Tasks.GetArtifactVersion)
	api.GET("/tasks/:id/versions/:version/artifacts", handlers.Tasks.ListArtifactsByVersion)
	api.GET("/tasks/:id/versions/:version/svg-bundle", handlers.Tasks.GetSVGBundleByVersion)
	api.GET("/tasks/:id/versions/:version/download/pptx", handlers.Tasks.DownloadPPTXByVersion)
	api.POST("/tasks/:id/edit-sessions", handlers.Tasks.CreateEditSession)
	api.GET("/tasks/:id/edit-sessions", handlers.Tasks.ListEditSessions)
	api.GET("/tasks/:id/edit-sessions/:sessionId", handlers.Tasks.GetEditSession)
	api.PUT("/tasks/:id/edit-sessions/:sessionId/draft", handlers.Tasks.SaveEditSessionDraft)
	api.POST("/tasks/:id/edit-sessions/:sessionId/apply", handlers.Tasks.ApplyEditSession)
	api.POST("/tasks/:id/edit-sessions/:sessionId/discard", handlers.Tasks.DiscardEditSession)
	api.POST("/tasks/:id/edit-sessions/:sessionId/clone", handlers.Tasks.CloneEditSession)
	api.POST("/tasks/:id/edit-sessions/:sessionId/retry", handlers.Tasks.RetryEditSession)
	api.GET("/tasks/:id/edit-sessions/:sessionId/runs", handlers.Tasks.ListEditRuns)
	api.GET("/tasks/:id/edit-sessions/:sessionId/pages/:pageId", handlers.Tasks.GetEditSessionPage)
