...
func fullPreflightFixture(t *testing.T) (*TaskService, *model.Task, *TaskWorkspace) {
	...
	mustWriteFile(t, filepath.Join(root, "scripts", "quality_runner.py"), "print('fixture')\n")
	mustWriteFile(t, filepath.Join(root, "scripts", "quality_schema.py"), "print('fixture')\n")
	mustWriteFile(t, filepath.Join(root, "scripts", "pptx_validate_runner.py"), "print('fixture')\n")
